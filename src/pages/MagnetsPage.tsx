...
import { flattenFiles, formatSize, formatSpeed } from "@/lib/debrid";
import { type ViewMode, resolvePageViewMode } from "@/lib/viewMode";
import { AppMenu, type Page } from "@/components/AppMenu";
import { PageHeader } from "@/components/PageHeader";
import { fetchWithTimeout, readJson, toastNetworkError } from "@/lib/networkError";
...
import {
  ...
  type StatusFilter,
  getStatusFilter,
} from "@/components/magnets/magnetUtils";
import { StatusBadge } from "@/components/magnets/StatusBadge";
import { ProgressBar } from "@/components/magnets/ProgressBar";
import { FilesModal } from "@/components/magnets/FilesModal";
import { Pagination } from "@/components/magnets/Pagination";
...
export function MagnetsPage({
  ...
  async function handleBulkDownload() {
    ...
    try {
      ...
      if (firstError) toastNetworkError(firstError, handleBulkDownload);
      setSelected(new Set());
    } catch (err) {
