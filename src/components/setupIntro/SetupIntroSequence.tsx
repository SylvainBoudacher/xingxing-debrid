  ...
  return (
    <div ref={rootRef} className="mx-auto w-full" style={{ maxWidth: STAGE.width }}>
      <div className="relative">
        {/* Lueur qui monte sous le cadre quand la lecture demarre. */}
        <div
          data-stage-glow
          className="pointer-events-none absolute -inset-32 bg-[radial-gradient(ellipse_at_center,rgba(99,102,241,0.34),rgba(99,102,241,0.10)_42%,transparent_70%)] opacity-0 blur-2xl"
        />
        <div
