...
const EXTENSION_RE = /\.(mkv|mp4|avi|mov|wmv|flv|webm|m4v|mpg|mpeg|ts|m2ts|3gp|ogv|vob|srt|sub|idx)$/i;
...
const CUT_RE = /\b((19|20)\d{2}|2160p|1080p|720p|480p|4k|uhd|multi|vostfr|vff|vf2?|truefrench|french|web(-?dl|rip)?|bluray|blu-ray|brrip|hdtv|hdlight|dvdrip|repack|proper|integrale|complete|saison|season)\b/i;
